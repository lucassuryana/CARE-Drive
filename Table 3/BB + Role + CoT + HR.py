...
# Calculate total number of runs - NOW INCLUDING MODELS
...
file_path = os.path.join(parent_directory, "Results_Parameter_Combinations_Role_CoT_HR.xlsx")

# Create initial Excel file with headers - ADDED MODEL COLUMN
wb = Workbook()
...
# Iterate over all combinations - MOVED MODEL LOOP TO OUTER LEVEL
            ...
            for traffic_behind_value in traffic_behind:
                for passenger_hurry_value in passenger_hurry:
                    ...
                    for run_in_combination in range(runs_per_combination):
                        ...
                        # Store results - ADDED MODEL TO RESULTS
                        ...
                        # Add to batch data - ADDED MODEL TO BATCH DATA
                        batch_data.append([
                            run_counter,
                            model_,
                            following_time,
                        ...
                        # Save to Excel every 20 runs or at the end
